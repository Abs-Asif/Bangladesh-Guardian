...
const Secret = () => {
  ...
  return (
    <div className="flex flex-col lg:flex-row min-h-screen bg-black text-white font-solaiman-regular">
      <Sidebar currentPage={currentPage} onPageChange={setCurrentPage} />
      <main className="flex-1 overflow-y-auto bg-[#020617] relative pt-16 lg:pt-0">
